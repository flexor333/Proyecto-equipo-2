                      ...
                      <div class="overflow-hidden shadow sm:rounded-md">
                          <div class="bg-white px-4 py-5 sm:p-6">
                              <div class="grid grid-cols-6 gap-6">
                                      ...
                                      <input type="disable" name="id" id="id" value="{{$cita->id}}" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                      <div class="col-span-6 sm:col-span-3">
                                       
                                        <div class="inline-block relative w-64">
                                        <input type="disable" name="id" id="id" value="{{$cita->doctor_id}}" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                  ...
                                  <div class="col-span-6">
                                      <label for="fecha" class="block text-sm font-medium text-gray-700">Titulo</label>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="descripcion" id="descripcion" autocomplete="descripcion" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                </div>
