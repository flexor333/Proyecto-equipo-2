                              ...
                              <div class="col-span-6 sm:col-span-3">
                                <br>
                                      <input type="hidden" name="id" id="id" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        ...
                                        <label for="body" class="block text-sm font-medium text-gray-700">Doctor</label>
                                        ...
                                        <!-- <div class="col-span-6 sm:col-span-3">
                                            <label for="doctors_id" class="block text-sm font-medium text-gray-700">Doctor id</label>
                                            <input type="text" name="doctors_id" id="doctors_id" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                        </div> -->
  
                                      <input type="hidden" name="patients_email" id="patients_email" value="{{ Auth::user()->email }}" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
  
                                  <div class="col-span-6">
                                      <label for="fecha" class=" rounded-lg text-sm font-medium text-gray-700 bg-green-400">Fecha</label>
                                      <input type="date" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="fecha" name="fecha">
                                  </div>

                                  <div class="inline-block relative w-64">
                                  <label for="body" class="block text-sm font-medium text-gray-700">Horarios</label>
                                        <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" name="horarios_id" id="horarios_id">
                                        ...
                                        <div class="inline-block relative w-64">
                                        <label for="body" class="block text-sm font-medium text-gray-700">Razon de la Cita</label>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="descripcion" id="descripcion" autocomplete="descripcion" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                </div>
