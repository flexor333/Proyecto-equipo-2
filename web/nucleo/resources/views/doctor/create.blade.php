                            ...
                            <div class="bg-white px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="email" name="email" id="email" autocomplete="given-name"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                         </div>
                                        ...
                                        <div class="col-span-6">
                                            <label for="body" class="block text-sm font-medium text-gray-700">Direecion</label>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input type="text"  name="especialidad" id="especialidad" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>

                                        </div>
                                        <div class="col-span-6">
                                            <label for="cedula" class="block text-sm font-medium text-gray-700">Cedula</label>
                                            <input type="text"  name="cedula" id="cedula" placeholder="ABC3312312333" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
